...
app.listen(8080, "ec2-23-21-57-219.compute-1.amazonaws.com");     // start the nodejs to be listening for incoming request @ port 8080
console.log("web server running @ http://ec2-23-21-57-219.compute-1.amazonaws.com:8080"); // output to console
