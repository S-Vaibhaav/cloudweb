function getAccountDetails(){
    ...
    getProfile.open("POST", "http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/userInfo", true);
...
function update() {
    ...
    updateUser.open("PUT", "http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/user", true)
        ...
        if (currentPassword == userPassword) {
            if (newPassword.length >= 8) {
                if (newPassword == confirmNewPassword) {
                    ...
                    updatePassword.open("PUT", "http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/user/password", true)
