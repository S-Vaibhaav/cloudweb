...
function registerMe() {
    ...
    registerUser.open("POST", "http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/signup", true)
...
function loginMe() {
    ...
    loginUser.open("POST", "http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/login", true)
