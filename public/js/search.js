...
function getSearchedRestaurants() {
    ...
    searchInput.addEventListener("keyup", (e) => {
        ...
        search.open('POST', 'http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/search', true)
...
function getFilteredRestaurants() {
    ...
    // if there is only region filter
        ...
        console.log(region)
        var search = new XMLHttpRequest();
            search.open('POST', 'http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/region', true)
            search.setRequestHeader("Content-type", "application/json")
            search.onload = function () {
                restaurant_array = JSON.parse(search.responseText);
                console.log(restaurant_array)
    ...
    // if there is only price filter
        ...
        var search = new XMLHttpRequest();
            search.open('POST', 'http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/price', true)
            search.setRequestHeader("Content-type", "application/json")
            search.onload = function () {
                restaurant_array = JSON.parse(search.responseText);
                console.log(restaurant_array)
    ...
    // if there is only cuisine and region filter
        ...
        var cuisineRegion = new XMLHttpRequest();
            cuisineRegion.open('POST', 'http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/cuisine/region', true)
    ...
    // if there is only cuisine and price filter
        ...
        console.log(cuisine,region)
        var cuisineRegion = new XMLHttpRequest();
            cuisineRegion.open('POST', 'http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/cuisine/price', true)
            cuisineRegion.setRequestHeader("Content-type", "application/json")
            cuisineRegion.onload = function () {
                restaurant_array = JSON.parse(cuisineRegion.responseText);
                console.log(restaurant_array)
    ...
    // if there is only region and price filter
        ...
        console.log(cuisine,region)
        var cuisineRegion = new XMLHttpRequest();
            cuisineRegion.open('POST', 'http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/region/price', true)
            cuisineRegion.setRequestHeader("Content-type", "application/json")
            cuisineRegion.onload = function () {
                restaurant_array = JSON.parse(cuisineRegion.responseText);
                console.log(restaurant_array)
    ...
    // if there is cuisine, region and price filter
        ...
        console.log(cuisine,region)
        var cuisineRegion = new XMLHttpRequest();
            cuisineRegion.open('POST', 'http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/cuisine/region/price', true)
            cuisineRegion.setRequestHeader("Content-type", "application/json")
            cuisineRegion.onload = function () {
                restaurant_array = JSON.parse(cuisineRegion.responseText);
                console.log(restaurant_array)
...
function getAllRestaurants() {
    ...
    request.open('GET', 'http://ec2-23-21-57-219.compute-1.amazonaws.com:8080/restaurants', true)
